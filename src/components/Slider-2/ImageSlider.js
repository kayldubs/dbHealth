...
const ImageSlider = ({ slides }) => {
  ...
  return (
    <Grid
      container
      row={{ xs: 2, sm: 1, lg: 1, xl: 1 }}
      columnSpacing={{ xs: 1, sm: 2, md: 2, lg: 1, xl: 1 }}
      alignItems="stretch"
    >
      ...
      >
        <Card className="col-lg-6 info-plane">
          ...
          >
            ...
            <p className="desc">
              Using wireless technology, our stethescope brings your health and
              patient accessibility into the modern age.
            </p>
            <br></br>
            <h2>Optimized remote patient monitoring</h2>
            <p className="desc">
              Never miss a beat with remote monitoring serving patients and
              providers alike.
            </p>
            <br></br>
            <h2>AI-Assisted detection of heartbeat abnormalities</h2>
            <p className="desc">
              AI-powered diagnosis identifies risks and provides timely alerts
              of patient statistics in real-time.
            </p>
            <br></br>
            <h2>Modern features for seamless usage</h2>
            <p className="desc">
              A reliable stethoscope with volume control, wireless connectivity,
              noise reduction, and dual streaming connection for accuracy.
            </p>
            <h3
        style={{
            fontSize:'14px',
