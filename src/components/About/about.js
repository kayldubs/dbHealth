...
const tiers = [
  ...
  },
  {
    ...
    title: "Payer",
    subheader:
      "As of 2022, 6.2 million adults are living in the U.S. with heart failure. Patients admitted for cardiac related events generate an average cost of $15 billion per year for Insurance payers. White papers indicate DigiBeat’s solution can provide a prospective $1.7 Billion in annual savings for payers. Our solution allows physicians to detect and monitor disease progression sooner and more effectively, ultimately reducing the number of chronic stage heart failure admissions and readmissions. We aim to provide payers the tools they need to remain competitive in a capitated system moving towards value based care.",
    description: [],
  },
];
        ...
        >
          <Container maxWidth="sm" justifyContent="center">
            ...
            <Typography fontSize="18px" align="center" color="text.secondary">
              At DigiBeat, we have created an innovative Digital Stethoscope and
              medical exam system which combines traditional methods of medical
              practice with current technologies in artificial intelligence and
              augmented reality to improve patient outcomes. By bridging
              together the diagnostic power of AI with the guidance capabilities
              of augmented reality, we have found a way to bring the
              auscultation examination process into the home. Opening up vast
              opportunities to better understand patient outcomes, medication
              efficacies, disease progressions, and health expectancies. All of
              which will help to reduce payer costs.
            </Typography>
            <Stack
              sx={{ pt: 4 }}
              direction="row"
          ...
          <React.Fragment>
            ...
            <Container maxWidth="lg" component="main" direction="row">
              <Grid
                container
                rowGap={{ xs: 6, sm: 6, md: 6, lg: 6, xl: 3 }}
                alignItems="stretch"
                  ...
                  >
                    <Card className="spacing2">
                      ...
                      <CardHeader
                        ...
                        titleTypographyProps={{ align: "center", fontFamily:'Source Sans Pro' }}
