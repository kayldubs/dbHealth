            ...
            >
              {index === current && (
                <Grid container className="hero-container">
                  <img
                    src={pictures.image}
                    alt="Showing multiple variations of DigiBeat's wireless stethoscope with in home, in office, and augmented reality use cases."
                    className="hero-image"
                  />
                  <Grid item direction="column" className="content">
